  ...
  return (
    <>
      <div className="space-y-4">
        ...
        {drives.length === 0 ? (
          <Card className="p-8 text-center text-xs text-[#64748B] bg-white border-slate-200">
            ...
            <p className="mt-1 text-slate-600">Job tracks and eligibility criteria will appear here once the recruitment drive is scheduled.</p>
          </Card>
        ) : (
            ...
            {drives.map((drive) => {
              ...
              return (
                <Card
                  key={drive.id}
                  hoverEffect
                  className="flex flex-col justify-between space-y-4 p-5 border-slate-200 bg-white"
                >
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {depts.map((d) => (
                          <span
                            key={d}
                            className="rounded bg-white border border-slate-200 px-1.5 py-0.5 text-[10px] font-bold text-slate-600"
                          >
                            {d}
                          </span>
                        ))}
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 text-xs leading-relaxed text-slate-700">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="rounded-xl border border-slate-100 bg-slate-100 p-3">
                  <span className="text-slate-600">Package (CTC)</span>
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-100 p-3">
                  <span className="text-slate-600">Min UG Cutoff</span>
                  <p className="text-sm font-bold text-white mt-0.5">
              ...
              <div className="space-y-2">
                ...
                <p className="bg-white rounded-xl p-4 border border-slate-100 text-slate-600 leading-relaxed">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  <div className="rounded-xl border border-slate-100 bg-white p-3">
                    ...
                    <p className="text-slate-600 mt-1 text-[11px]">Coding algorithms, quantitative aptitude, and core domain MCQs.</p>
                  </div>
                  <div className="rounded-xl border border-slate-100 bg-white p-3">
                    <span className="font-bold text-white">Round 2: Technical Interview 1</span>
                    <p className="text-slate-600 mt-1 text-[11px]">Data structures, problem solving, system design, and live coding.</p>
                  </div>
                  <div className="rounded-xl border border-slate-100 bg-white p-3">
                    <span className="font-bold text-white">Round 3: Advanced Technical & Project Deep-Dive</span>
                    <p className="text-slate-600 mt-1 text-[11px]">Architecture discussion, past internships, and domain problem solving.</p>
                  </div>
                  <div className="rounded-xl border border-slate-100 bg-white p-3">
                    <span className="font-bold text-white">Round 4: HR & Leadership Fitment</span>
                    <p className="text-slate-600 mt-1 text-[11px]">Behavioral assessment, culture fitment, and compensation offer discussion.</p>
                  </div>
                </div>
              </div>
            </div>
